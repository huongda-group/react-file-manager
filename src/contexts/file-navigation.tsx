...
export const FileNavigationProvider = ({
  ...
  const contextValue = useMemo(() => ({
    ...
    currentPath, setCurrentPath, currentFolder, currentPathFiles,
    sortConfig, setSortConfig, onFolderChange, editingFileId,
    setEditingFileId, tempNewFolder, setTempNewFolder
  ]);
