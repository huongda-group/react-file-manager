...
const useFileList = (onRefresh, enableFilePreview, triggerAction, permissions) => {
    ...
    const emptySelecCtxItems = [
        {
            title: t("view"),
            icon: activeLayout === "grid" ? _jsx(BsGrid, { size: 18 }) : _jsx(FaListUl, { size: 18 }),
            onClick: () => { },
            children: [
                {
                    title: t("grid"),
                    icon: _jsx(BsGrid, { size: 18 }),
        ...
        {
            title: t("refresh"),
            icon: _jsx(FiRefreshCw, { size: 18 }),
            onClick: handleRefresh,
            divider: true,
        },
        {
            title: t("newFolder"),
            icon: _jsx(BsFolderPlus, { size: 18 }),
        ...
        {
            title: t("selectAll"),
            icon: _jsx(BiSelectMultiple, { size: 18 }),
    ...
    const selecCtxItems = [
        {
            title: t("open"),
            icon: lastSelectedFile?.isDirectory ? _jsx(PiFolderOpen, { size: 20 }) : _jsx(FaRegFile, { size: 16 }),
            onClick: handleFileOpen,
            divider: true,
        },
        {
            title: t("cut"),
            icon: _jsx(BsScissors, { size: 19 }),
        ...
        {
            title: t("copy"),
            icon: _jsx(BsCopy, { strokeWidth: 0.1, size: 17 }),
        ...
        {
            title: t("download"),
            icon: _jsx(MdOutlineFileDownload, { size: 18 }),
            onClick: handleDownloadItems,
            hidden: !permissions.download,
        },
        {
            title: t("delete"),
            icon: _jsx(MdOutlineDelete, { size: 19 }),
