...
export const useFileIcons = (size?: number): Record<string, ReactElement> => {
  // Memoizing the file icons map to avoid recreating numerous React Elements on every render.
  // This drastically reduces memory allocations and garbage collection overhead,
  // especially in FileList where useFileIcons is called multiple times per FileItem.
